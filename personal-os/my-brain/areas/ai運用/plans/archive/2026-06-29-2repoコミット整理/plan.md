...
- 計画バケット化の Skill 側書き換え（`../2026-06-29-計画バケット化/ops/ai/codex-skill-bucket化.md`）が完了し、
...
- 計画バケット化: `../2026-06-29-計画バケット化/plan.md`
- plans廃止移行（完了）: `../../archive/2026-06-29-plans廃止とarea一本化/plan.md`

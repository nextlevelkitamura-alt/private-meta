...
- 戻り先: 子計画が必要なら `manage-program.md`、評価・遷移なら `review-and-transition.md`、実装中レーンの監督なら `cockpit-supervisor`。
- 完了確認: 既存plan優先、plan本文の正本が1つ、必要なレビュー項目、routeと書込み範囲の一致を確認する。
